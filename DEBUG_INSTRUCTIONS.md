...
The successful reusable patch was created on:
...
or binary AAR files. The maintenance branch `speed-test-2.0.18` is the practical
branch to use for future local builds.
...
V2rayNG/app/src/main/java/com/v2ray/ang/service/V2RayTestService.kt
